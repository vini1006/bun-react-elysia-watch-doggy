  ...
  if (true) {
    (function () {
      ...
      var validateProperty$1 = function () {};
      {
        ...
        validateProperty$1 = function (tagName, name, value, eventRegistry) {
          ...
          if (eventRegistry != null) {
            var {
              registrationNameDependencies: registrationNameDependencies2,
              possibleRegistrationNames: possibleRegistrationNames2,
            } = eventRegistry;
      ...
      function diffHydratedProperties(
        ...
        for (var propKey in rawProps) {
          ...
          if (propKey === CHILDREN) {
            ...
            var propertyInfo =
              isCustomComponentTag && enableCustomElementPropertySupport ? null : getPropertyInfo(propKey);
            if (rawProps[SUPPRESS_HYDRATION_WARNING] === true);
            else if (
      ...
      function applyDerivedStateFromProps(workInProgress2, ctor, getDerivedStateFromProps, nextProps) {
        ...
        var memoizedState =
          partialState === null || partialState === undefined ? prevState : assign({}, prevState, partialState);
        ...
        function warnOnInvalidKey(child, knownKeys, returnFiber) {
          {
            ...
            switch (child.$$typeof) {
              ...
              case REACT_PORTAL_TYPE:
                ...
                error(
                  'Encountered two children with the same key, `%s`. Keys should be unique so that components maintain their identity across updates. Non-unique keys may cause children to be ' +
      ...
      var { ReactCurrentDispatcher: ReactCurrentDispatcher$1, ReactCurrentBatchConfig: ReactCurrentBatchConfig$2 } =
      ...
      function renderWithHooks(current2, workInProgress2, Component2, props, secondArg, nextRenderLanes) {
        ...
        workInProgressHook = null;
        {
          ...
          if (
            current2 !== null &&
            (current2.flags & StaticMask) !== (workInProgress2.flags & StaticMask) &&
        ...
        if (!didSuspend) {
          ...
          if (workInProgress2.flags & ForceClientRender) {
            ...
            var _capturedValue2 = createCapturedValue(
              new Error('There was an error while hydrating this Suspense boundary. Switched to client rendering.'),
            );
            ...
            if (includesOnlyRetries(lanes) && !shouldForceFlushFallbacksInDEV()) {
              ...
              if (msUntilTimeout > 10) {
                ...
                root2.timeoutHandle = scheduleTimeout(
                  commitRoot.bind(null, root2, workInProgressRootRecoverableErrors, workInProgressTransitions),
                  msUntilTimeout,
                );
                break;
              }
        ...
        beginWork$1 = function (current2, unitOfWork, lanes) {
          ...
          try {
            ...
            if (
              ...
              (originalError !== null && typeof originalError === 'object' && typeof originalError.then === 'function')
            ) {
              throw originalError;
            }
            resetContextDependencies();
...
// node_modules/react/cjs/react-jsx-dev-tools-runtime.development.js
...
// node_modules/react/jsx-dev-tools-runtime.js
...
var App = () => {
  ...
  return jsx_dev_runtime.jsxDEV(
    jsx_dev_runtime.Fragment,
    {
      children: [
        jsx_dev_runtime.jsxDEV(
          'h1',
          {
...
root.render(jsx_dev_runtime2.jsxDEV(App_default, {}, undefined, false, undefined, this));
(() => {
  let __socket;
  __initSocket();
  function __initSocket() {
    __socket = new WebSocket('ws://localhost:8080/dev');
